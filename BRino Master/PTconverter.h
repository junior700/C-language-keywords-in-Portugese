...
#define NumeroLongo long //: valores númericos inteiros até 2147483647 (long)
#define LongLongo long//: valores númericos até 9223372036854775807 (long long)
#define Palavra String  //: sequência de caracteres (String)
#define VERDADEIRO  TRUE  //  : valor binário Verdadeiro ou Falso (boolean)
#define FALSO  FALSE 
//Modificadores

#define Modulo  unsigned   //: utiliza somente o valor e ignora o sinal do número (unsigned)
#define Constante  const  //: indica que a variável possui valor constante, ou seja, não mudará durante a execução (const)
...
//USB.ler():lê os dados disponíveis na porta serial(.read())
#define ler read    // termo vale para leitura em varias instâncias
#define escrever  write   // termo vale para escrita em varias instâncias
